...
(* canonicalizar *)
val canonicalizate: tigerframe.frag list -> ((tigertree.stm list * tigerframe.frame) list * (tigertemp.label * string) list)

(* imprime el IR canonicalizado *)
val printcanon: ((tigertree.stm list * tigerframe.frame) list * (tigertemp.label * string) list) -> unit
