...
val procEntryExit2 : tigerassem.instr list * frame -> tigerassem.instr list
val procEntryExit3 : tigerassem.instr list * frame -> {prolog: string, body: tigerassem.instr list, epilog: string}
